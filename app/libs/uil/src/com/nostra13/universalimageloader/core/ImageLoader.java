...
//	}
	...
	/**
	 * A convenience method that returns a clone of default display options set's builder for this image loader instance.
	 *
	 * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 */
	public DisplayImageOptions.Builder getDefaultDisplayImageOptions() {
		checkConfiguration();
		return new DisplayImageOptions.Builder().cloneFrom(configuration.defaultDisplayImageOptions);
	}
